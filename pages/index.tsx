    ...
    <>
      ...
      <DefaultLayout mainProps={{className: 'bg-background pl-16'}} footerProps={{children: <FooterContent />}}>
        <section className="h-screen">
          ...
          <p className="text-2xl text-typo-light font-body">Fullstack Webdeveloper</p>
        </section>
        <section className="h-screen">
          <h2 id="about" className="text-4xl text-typo-dark font-display">About</h2>
        </section>
        <section className="h-screen">
          <h2 id="contact" className="text-4xl text-typo-dark font-display">Contact</h2>
